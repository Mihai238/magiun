...
class RestrictionBuilderTest extends UnitTest {
  ...
  it should "build shacl restricitons" in {
    ...
    restrictions("MissingValue").check("hehe") should be(false)
    restrictions("MissingValue").check("NA") should be(true)
    restrictions("MissingValue").check("unknown") should be(true)
    restrictions("MissingValue").check("other") should be(true)
    restrictions("MissingValue").check("Other") should be(true)
    restrictions("MissingValue").check("") should be(true)
  }
