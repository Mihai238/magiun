...
object OntologyClass extends Enum[OntologyClass] with CirceEnum[OntologyClass] {
  ...
  case object MultinomialNaiveBayesClassification extends OntologyClass(NS + "MultinomialNaiveBayesClassification", "Multinomial Naive Bayes Classification")

  case object BernoulliNaiveBayesClassification extends OntologyClass(NS + "BernoulliNaiveBayesClassification", "Bernoulli Naive Bayes Classification")
  ...
  case object GeneralizedLinearRegressionPoissonLogPartial extends OntologyClass(NS + "GeneralizedLinearRegressionPoissonLogPartial", "Generalized Linear Regression Partial - family: poisson & identity: log")
  ...
  val regressions = List(
    ...
    LinearLeastRegressionComplete,
    GeneralizedLinearRegressionIdentityPartial,
    GeneralizedLinearRegressionIdentityComplete,
    GeneralizedLinearRegressionBinomialLogitPartial,
    GeneralizedLinearRegressionBinomialLogitComplete,
    GeneralizedLinearRegressionExponentialInversePartial,
    GeneralizedLinearRegressionExponentialInverseComplete,
    GeneralizedLinearRegressionPoissonLogPartial,
    GeneralizedLinearRegressionPoissonLogComplete,
    IsotonicRegression,
    SurvivalRegression,
    GradientBoostTreeRegressionPartial,
    GradientBoostTreeRegressionComplete,
    RandomForestRegressionPartial,
    RandomForestRegressionComplete,
    DecisionTreeRegressionPartial,
    DecisionTreeRegressionComplete
  )

  val classifications = List(
    BinaryLogisticRegressionPartial,
    BinaryLogisticRegressionComplete,
    MultinomialLogisticRegressionPartial,
    MultinomialLogisticRegressionComplete,
    MultinomialNaiveBayesClassification,
    BernoulliNaiveBayesClassification,
    LinearSupportVectorMachine,
    MultilayerPerceptronClassification,
    RandomForestClassificationComplete,
    RandomForestClassificationPartial,
    GradientBoostTreeClassification,
    DecisionTreeClassificationComplete,
    DecisionTreeClassificationPartial
  )
